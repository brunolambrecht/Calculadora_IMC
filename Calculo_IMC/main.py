...
frame_cima = Frame(janela, width=295, height=50, bg=co0, padx=0, relief='flat')
frame_cima.grid(row=0, column=0, sticky=NSEW)
frame_baixo = Frame(janela, width=295, height=180, bg=co0, padx=0, relief='flat')
frame_baixo.grid(row=1, column=0, sticky=NSEW)

# --------- Configurando frame cima
app_nome = Label(frame_cima, text='Calculadora IMC', width=23, height=1, padx=0, relief='flat', anchor='center', font=('Ivy 16 bold '), bg=co0, fg=co1)
